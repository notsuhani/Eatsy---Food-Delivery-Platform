        ...
        {step == 2 &&
          <div>
            <div className='mb-6'>
              ...
              {/* Changed type from "email" to "text" for OTP */}
              <input type="text" className='w-full border-[1px] border-gray-200 rounded-lg px-3 py-2 focus:outline-none' placeholder='Enter OTP' onChange={(e)=>setOtp(e.target.value)} value={otp} />
            </div>
        ...
        {step == 3 &&
          <div>
            <div className='mb-6'>
              ...
              {/* Changed type from "email" to "password" */}
